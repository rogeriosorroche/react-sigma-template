            ...
            <div className="col-12 md:col-6">
                <div className="card p-fluid">
                    ...
                    <div className="p-field grid">
                        <label htmlFor="name3" className="col-12 md:col-2 md:col-2 md:col-md-0">Name</label>
                        <div className="col-12 md:col-10">
                            <InputText id="name3" type="text" />
                        </div>
                    </div>
                    <div className="p-field grid">
                        <label htmlFor="email3" className="col-12 md:col-2 md:col-2 md:col-md-0">Email</label>
                        <div className="col-12 md:col-10">
