        ...
        <div className="grid panel-demo">
            ...
            <div className="col-12">
                <div className="card">
                    <h5>Divider</h5>
                    <div className="grid">
                        <div className="col-5 flex p-ai-center justify-content-center">
                        ...
                        <div className="col-5 p-ai-center justify-content-center">
            ...
            <div className="col-12">
                <div className="card">
                    <h5>Splitter</h5>
                    <Splitter style={{ height: '300px' }} className="md:col-5">
