        ...
        <div className="grid misc-demo">
            ...
            <div className="col-12 lg:col-6">
                <div className="card">
                    ...
                    <h5 className="md:col-4">Positioned Badge</h5>
                    <i className="pi pi-bell mr-4 text-secondary p-overlay-badge" style={{ fontSize: '2rem' }}><Badge value="2" ></Badge></i>
                    <i className="pi pi-calendar mr-4 text-secondary p-overlay-badge" style={{ fontSize: '2rem' }}><Badge value="10+" severity="danger" ></Badge></i>
                    <i className="pi pi-envelope text-secondary p-overlay-badge" style={{ fontSize: '2rem' }}><Badge severity="danger"></Badge></i>
                ...
                <div className="card">
                    <h4>Avatar</h4>
                    <h5>Avatar Group</h5>
                    <AvatarGroup className="md:col-3">
            ...
            <div className="col-12 lg:col-6">
                ...
                <div className="card">
                    <h4>Chip</h4>
                    <h5>Basic</h5>
                    <div className="flex p-ai-center flex-wrap">
                        <Chip label="Action" className="mr-2 md:col-2" />
                        <Chip label="Comedy" className="mr-2 md:col-2" />
                        <Chip label="Mystery" className="mr-2 md:col-2" />
                        <Chip label="Thriller" className="md:col-2" removable />
                    </div>

                    <h5>Icon</h5>
                    <div className="flex p-ai-center flex-wrap">
                        <Chip label="Apple" icon="pi pi-apple" className="mr-2 md:col-2" />
                        <Chip label="Facebook" icon="pi pi-facebook" className="mr-2 md:col-2" />
                        <Chip label="Google" icon="pi pi-google" className="mr-2 md:col-2" />
                        <Chip label="Microsoft" icon="pi pi-microsoft" className="md:col-2" removable />
                    </div>

                    <h5>Image</h5>
                    <div className="flex p-ai-center flex-wrap">
                        <Chip label="Amy Elsner" image="assets/demo/images/avatar/amyelsner.png" className="mr-2 md:col-2" />
                        <Chip label="Asiya Javayant" image="assets/demo/images/avatar/asiyajavayant.png" className="mr-2 md:col-2" />
                        <Chip label="Onyama Limba" image="assets/demo/images/avatar/onyamalimba.png" className="mr-2 md:col-2" />
                        <Chip label="Xuxue Feng" image="assets/demo/images/avatar/xuxuefeng.png" className="md:col-2" removable />
                    </div>

                    <h5>Styling</h5>
                    <div className="flex p-ai-center flex-wrap">
                        <Chip label="Action" className="mr-2 md:col-2 custom-chip" />
                        <Chip label="Apple" icon="pi pi-apple" className="mr-2 md:col-2 custom-chip" />
                        <Chip label="Onyama Limba" image="assets/demo/images/avatar/onyamalimba.png" className="mr-2 md:col-2 custom-chip" />
                        <Chip label="Xuxue Feng" image="assets/demo/images/avatar/xuxuefeng.png" className="custom-chip md:col-2" removable />
                    </div>
                </div>
                ...
                <div className="card">
                    ...
                    <div className="custom-skeleton p-p-4">
                        <div className="flex md:col-3">
                            <Skeleton shape="circle" size="4rem" className="mr-2"></Skeleton>
                            <div>
                                <Skeleton width="10rem" className="md:col-2"></Skeleton>
                                <Skeleton width="5rem" className="md:col-2"></Skeleton>
                                <Skeleton height=".5rem"></Skeleton>
                            </div>
                        </div>
                        <Skeleton width="100%" height="150px"></Skeleton>
                        <div className="flex justify-content-between p-mt-3">
