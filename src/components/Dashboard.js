...
export const Dashboard = () => {
    ...
    return (
        <div className="grid p-fluid dashboard">
            ...
            <div className="col-12 md:col-6 md:col-4">
                ...
                <div className="card">
                    ...
                    <DataTable value={products} className="p-datatable-customers" rows={5} style={{ marginBottom: '20px' }} paginator>
                        ...
                        <Column header="View" body={() => (
                            <>
                                <Button icon="pi pi-search" type="button" className="p-button-success mr-2 md:col-1"></Button>
                                <Button icon="pi pi-times" type="button" className="p-button-danger md:col-1"></Button>
                            </>
                        )}></Column>
                    </DataTable>
                </div>
            ...
            <div className="col-12 lg:col-4">
                <Panel header="Activity" style={{ height: '100%' }}>
                    ...
                    <ul className="activity-list">
                        <li>
                            <div className="flex justify-content-between p-ai-center md:col-3">
