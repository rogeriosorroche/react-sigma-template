...
export const MessagesDemo = () => {
    ...
    return (
        <div className="grid messages-demo">
            ...
            <div className="col-12 lg:col-8">
                <div className="card">
                    <h5>Inline</h5>
                    <div className="p-field grid p-align-start">
                        <label htmlFor="username1" className="col-fixed">Username</label>
                        <div className="p-col">
                    ...
                    <div className="p-field grid">
                        <label htmlFor="email" className="col-fixed">Email</label>
                        <div className="p-col">
