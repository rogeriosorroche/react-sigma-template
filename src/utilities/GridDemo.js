...
export const GridDemo = () => {
    ...
    return (
        <div className="flexgrid-demo">
            ...
            <div className="grid p-dir-col-rev">
                <div className="p-col">
                    <div className="box">1</div>
                </div>
                <div className="p-col">
            ...
            <div className="grid">
                <div className="col-12 md:col-6 lg:col-3">
                    <div className="box">col-12 md:col-6 lg:col-3</div>
                </div>
                <div className="col-12 md:col-6 lg:col-3">
                    <div className="box">col-12 md:col-6 lg:col-3</div>
                </div>
            ...
            <div className="grid p-justify-start">
                <div className="col-2">
                    <div className="box">2</div>
                </div>
                <div className="col-1">
            ...
            <div className="grid p-justify-end">
                <div className="col-2">
                    <div className="box">2</div>
                </div>
                <div className="col-1">
            ...
            <div className="grid p-justify-around">
                <div className="col-2">
                    <div className="box">2</div>
                </div>
                <div className="col-1">
            ...
            <div className="grid p-justify-even">
                <div className="col-2">
                    <div className="box">2</div>
                </div>
                <div className="col-1">
            ...
            <div className="grid p-align-start vertical-container">
                <div className="p-col">
                    <div className="box">4</div>
                </div>
                <div className="p-col">
            ...
            <div className="grid p-align-end vertical-container">
                <div className="p-col">
                    <div className="box">4</div>
                </div>
                <div className="p-col">
            ...
            <div className="grid p-align-center vertical-container">
                <div className="p-col">
                    <div className="box">4</div>
                </div>
                <div className="p-col">
            ...
            <div className="grid p-align-stretch vertical-container">
                <div className="p-col">
            ...
            <div className="grid vertical-container">
                <div className="p-col col-align-start">
                    <div className="box">4</div>
                </div>
                <div className="p-col col-align-center">
                    <div className="box">4</div>
                </div>
                <div className="p-col col-align-end">
                    <div className="box">4</div>
                </div>
            </div>
            ...
            <h5>Offset</h5>
            <div className="grid">
                <div className="col-6 p-offset-3">
                    <div className="box">6</div>
                </div>
            </div>
            ...
            <div className="grid">
                ...
                <div className="col-4 p-offset-4">
                    <div className="box">4</div>
                </div>
            </div>
